...
public class SeatCompanyController {
        ...
        public ResponseEntity<ApiResponse<SeatResponse>> getSeatDetail(
                ...
                try {
                        ...
                        log.error("💥 [BUS COMPANY] 500 INTERNAL_SERVER_ERROR - Failed to get seat detail: {}", seatId,
                                        e);
                        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                                        .body(ApiResponse.<SeatResponse>builder()
                                                        .success(false)
        ...
        public ResponseEntity<ApiResponse<SeatResponse>> updateSeatStatus(
                ...
                try {
                        ...
                        log.error("💥 [BUS COMPANY] 500 INTERNAL_SERVER_ERROR - Failed to update seat status: {}",
                                        seatId, e);
                        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                                        .body(ApiResponse.<SeatResponse>builder()
                                                        .success(false)
        ...
        public ResponseEntity<ApiResponse<SeatResponse>> updateSeatPrice(
                ...
                try {
                        ...
                        log.error("💥 [BUS COMPANY] 500 INTERNAL_SERVER_ERROR - Failed to update seat price: {}",
                                        seatId, e);
                        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                                        .body(ApiResponse.<SeatResponse>builder()
                                                        .success(false)
