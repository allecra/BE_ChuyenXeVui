...
@RestController
@RequestMapping("/bus-company/routes")
...
public class RouteCompanyController {
        ...
        @PostMapping("/test")
        @SecurityRequirements() // Bỏ authentication requirement
        public ResponseEntity<Map<String, Object>> testCreateRoute(@RequestBody Map<String, Object> rawRequest) {
                log.info("🧪 [TEST] Raw request body: {}", rawRequest);

                Map<String, Object> response = new HashMap<>();
                response.put("success", true);
                response.put("message", "Test endpoint received data");
        ...
        public ResponseEntity<ApiResponse<RouteResponse>> createRoute(
                ...
                log.info("🚌 [BUS COMPANY] POST /bus-company/routes - Create route");
                log.info("🔐 [BUS COMPANY] User: {}, Authorities: {}",
                                authentication.getName(), authentication.getAuthorities());
                log.info("📝 [BUS COMPANY] Request body: {}", request);
                log.info("📝 [BUS COMPANY] Route name: {}", request != null ? request.getRouteName() : "NULL REQUEST");
                log.info("📝 [BUS COMPANY] Departure Station ID: {}",
                                request != null ? request.getDepartureStationId() : "NULL REQUEST");
                log.info("📝 [BUS COMPANY] Arrival Station ID: {}",
                                request != null ? request.getArrivalStationId() : "NULL REQUEST");
                ...
                if (request.getDepartureStationId() == null) {
                        throw new IllegalArgumentException("DepartureStationId is null");
                }
                if (request.getArrivalStationId() == null) {
                        throw new IllegalArgumentException("ArrivalStationId is null");
                }
                ...
                try {
                        ...
                        log.info("🏢 [BUS COMPANY] Bus Company ID: {}", busCompanyId);
        ...
        public ResponseEntity<ApiResponse<RouteResponse>> getRouteDetail(
                ...
                try {
                        ...
                        log.error("💥 [BUS COMPANY] 500 INTERNAL_SERVER_ERROR - Failed to get route detail: {}",
                                        routeId, e);
                        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                                        .body(ApiResponse.<RouteResponse>builder()
                                                        .success(false)
        ...
        public ResponseEntity<ApiResponse<RouteResponse>> updateRoute(
                ...
                try {
                        ...
                        log.error("💥 [BUS COMPANY] 500 INTERNAL_SERVER_ERROR - Failed to update route: {}", routeId,
                                        e);
                        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                                        .body(ApiResponse.<RouteResponse>builder()
                                                        .success(false)
        ...
        public ResponseEntity<ApiResponse<Page<RouteResponse>>> searchRoutes(
                ...
                try {
                        ...
                        if (status != null) {
                                request.setStatus(com.example.ckdatveexe.shared.entity.RouteStatus
                        ...
                        log.info("✅ [BUS COMPANY] 200 OK - Found {} routes matching search criteria",
        ...
        public ResponseEntity<ApiResponse<Void>> deleteRoute(
                ...
                try {
                        ...
                        log.error("💥 [BUS COMPANY] 500 INTERNAL_SERVER_ERROR - Failed to delete route: {}", routeId,
                                        e);
                        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                                        .body(ApiResponse.<Void>builder()
                                                        .success(false)
        ...
        public ResponseEntity<ApiResponse<List<BusResponse>>> getBusesOnRoute(
                ...
                try {
                        ...
                        log.error("💥 [BUS COMPANY] 500 INTERNAL_SERVER_ERROR - Failed to get buses on route: {}",
                                        routeId, e);
                        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                                        .body(ApiResponse.<List<BusResponse>>builder()
                                                        .success(false)
        ...
        public ResponseEntity<ApiResponse<RouteStationResponse>> addStationToRoute(
                ...
                try {
                        Integer busCompanyId = getBusCompanyIdFromAuth(authentication);
                        RouteStationResponse routeStation = routeStationService.addStationToRoute(routeId, request,
                                        busCompanyId);
                        ...
                        log.error("💥 [BUS COMPANY] 500 INTERNAL_SERVER_ERROR - Failed to add station to route: {}",
                                        routeId, e);
                        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                                        .body(ApiResponse.<RouteStationResponse>builder()
                                                        .success(false)
        ...
        public ResponseEntity<ApiResponse<List<RouteStationResponse>>> getRouteStations(
                ...
                try {
                        Integer busCompanyId = getBusCompanyIdFromAuth(authentication);
                        List<RouteStationResponse> stations = routeStationService.getRouteStations(routeId,
                                        busCompanyId);

                        log.info("✅ [BUS COMPANY] 200 OK - Retrieved {} stations for route ID: {}", stations.size(),
                                        routeId);
                        ...
                        log.error("💥 [BUS COMPANY] 500 INTERNAL_SERVER_ERROR - Failed to get route stations: {}",
                                        routeId, e);
                        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                                        .body(ApiResponse.<List<RouteStationResponse>>builder()
                                                        .success(false)
        ...
        public ResponseEntity<ApiResponse<RouteStationResponse>> updateRouteStation(
                ...
                try {
                        Integer busCompanyId = getBusCompanyIdFromAuth(authentication);
                        RouteStationResponse routeStation = routeStationService.updateRouteStation(routeId, stationId,
                                        request,
                                        busCompanyId);

                        log.info("✅ [BUS COMPANY] 200 OK - Route station updated successfully: {}",
                                        routeStation.getStationName());
                        ...
                        log.error("💥 [BUS COMPANY] 500 INTERNAL_SERVER_ERROR - Failed to update route station: {}/{}",
                                        routeId,
                                        stationId, e);
                        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                                        .body(ApiResponse.<RouteStationResponse>builder()
        ...
        public ResponseEntity<ApiResponse<Void>> removeStationFromRoute(
                ...
                log.info("🚌 [BUS COMPANY] DELETE /api/bus-company/routes/{}/stations/{} - Remove station from route",
                                routeId,
                                stationId);
                log.info("🔐 [BUS COMPANY] User: {}, Authorities: {}",
                                authentication.getName(), authentication.getAuthorities());
                ...
                try {
                        ...
                        log.info("✅ [BUS COMPANY] 200 OK - Station removed from route successfully: {}/{}", routeId,
                                        stationId);
                        return ResponseEntity.ok(ApiResponse.<Void>builder()
                                        .success(true)
